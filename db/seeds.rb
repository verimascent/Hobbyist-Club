...
Event.create!(user: u, name: 'Ancient Chinese Book Club', description: 'Read Zuo Zhuan（左传）with Silas', limit:10, address:'Xnode, Shanghai', date: "Sun, 12 Dec 2021",
  start_time: "Sun, 12 Dec 2021 14:00:00.000000000 UTC +00:00", end_time: "Sun, 12 Dec 2021 16:00:00.000000000 UTC +00:00", img_url:'https://media.istockphoto.com/photos/chinese-traditional-medicine-ancient-book-with-clipping-paths-picture-id92135111?b=1&k=20&m=92135111&s=170667a&w=0&h=ScYyK4yaQcc04E9ghiemoIM1YKRYXxpC09vkJYSn8GQ=')

Event.create!(user: u, name: 'Coding with YISY', description: 'This is a codewar between YISY and whoever dare to join', limit:10, address:'BoxingCat, Fuxing Middle Road, Shanghai', date: "Sat, 04 Dec 2021",
  start_time: "Fri, 26 Nov 2021 19:10:00.000000000 UTC +00:00", end_time: "26 Nov 2021 03:14:08.973980000 UTC +00:00", img_url:'https://i.icanvas.com/ADL9?d=2&sh=v&p=1&bg=g&t=1632145674')
