...
Event.create!(user: u, name: 'Code in the Dark', description: 'Free Flow Pizza', limit:'20', address:'CoderBunder', date: Sat, 04 Dec 2021
...
Event.create!(user: u, name: 'Second-hand Swap', description: '冬日断舍离', limit:'15', address:'Yanping Rd', date: Sun, 27 Nov 2021,
...
Event.create!(user: u, name: 'Ancient Chinese Book Club', description: 'Read Zuo Zhuan（左传）with Silas', limit:'10', address:'Xnode', date: Sun, 12 Dec 2021
